...
class App extends Component {
  ...
  validate = () => {
    ...
    for (const key in keyList) {
      if (key !== "file") {
        if (this.state.touched[key] && checkEmpty(this.state[key])) {
          errors[key] = `${keyList[key]} is not empty`;
        }
      }
    }
      ...
      <div className="App">
        ...
        <form onSubmit={this.handleSubmit} noValidate>
          ...
          <div className="form-group">
            ...
            <input
              className={classNames({ error: tel !== "" })}
              required
              type="tel"
              name="tel"
          ...
          <div className="form-group">
            ...
            <input
              className={classNames({ error: weight !== "" })}
              required
              type="number"
              id="weight"
              name="weight"
          ...
          <div>
            ...
            <textarea
              className={classNames({ error: bio !== "" })}
              id="bio"
              name="bio"
          ...
          <div>
            <input
              className={classNames({ error: file !== "" })}
              required
              type="file"
              name="file"
              onChange={this.handleChange}
